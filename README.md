...
After adjusting toggle of packages, settings will be saved to default preferences path. Every first install of Editor Tools will automatically update packages accordingly.</p>
