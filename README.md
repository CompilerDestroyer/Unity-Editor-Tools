...
<span style="background-color:white; color:black; padding:2px 6px; border-radius:3px;">White Label</span>
<span style="background-color:#e0e0e0; color:black; padding:2px 6px; border-radius:3px;">Grey Label</span>
